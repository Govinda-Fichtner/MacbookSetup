...
tap "homebrew/cask-fonts"       # Required for installing Nerd Fonts (needed by Starship prompt)
...
# Without these fonts, Starship will still work but may show missing character symbols
